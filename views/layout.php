        ...
        <body class="container-fluid vh-100 bg-dark text-white p-0">
            <nav class="navbar navbar-expand-lg bg-black mb-3">
                <div class="container-fluid ">
                    <a class="navbar-brand text-white" href="http://localhost/Proyectos-REDI/Curriculum/mi-proyecto/?page=sobreMi">Sobre mi</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link text-white" href="http://localhost/Proyectos-REDI/Curriculum/mi-proyecto/?page=experiencia">Experiencia</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
function layoutFooter(): string
{
    ...
    $outputFooter =
        <<<HTML
            ...
            <div class="container-fluid bg-black p-0 m-0 h-12">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top h-100">
                    ...
                    <ul class="nav h-100 col-md-4 justify-content-center gap-4 align-items-center list-unstyled d-flex h-100 w-25">
                        <li class="ms-3 w-15 rounded-circle animation-contact">
                            <a class="d-flex justify-content-center" target="_blank" href="https://www.linkedin.com/in/jose-manuel-mendoza-murillo-74a515247/">
                        ...
                        <li class="ms-3 w-15 rounded-circle animation-contact">
                            <a class="d-flex justify-content-center" target="_blank" href="https://github.com/JoseManuelMendozaMurillo">
                            <svg class="fs-3 animate-contact-img" viewBox="0 0 16 16">
                        ...
                        <li class="ms-3 w-15 rounded-circle animation-contact">
                            <a class="d-flex justify-content-center" target="_blank" href="https://www.facebook.com/josemanuel.mendozamurillo">
                                <svg class="fs-3 animate-contact-img"  viewBox="0 0 16 16">
